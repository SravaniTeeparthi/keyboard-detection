...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen)
{
    ...
    while(1){
        ...
        // draw_detections(im, dets, nboxes, thresh, names, alphabet, l.classes); // commented by sravani
        save_detections(im, input, dets, nboxes, thresh, names, alphabet, l.classes); // sravani
        free_detections(dets, nboxes);
        if(outfile){
